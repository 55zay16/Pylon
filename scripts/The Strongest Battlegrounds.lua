...
local CANAUTOFARM = false
local AutoFarm = Core.UIlib:CreateButton(Combat, "Auto Farm",{},function(NewStatus)
    CANAUTOFARM = NewStatus
end)
...
local TPAURASettings = {
    ...
    ["Anti Death Health Threshold"] = {
        ["Object"] = nil,
        ["Type"] = "TextBox",
        ["Placeholder"] = "Health Threshold (20)",
        ["Value"] = 20,
    },
}
...
coroutine.wrap(function()
    while task.wait() do
        local s,e = pcall(function()
            if CANAUTOFARM == true then
                local TargetPlayer = GetNearestPlayer(100000)

                if TargetPlayer then
                    lplr.Character.HumanoidRootPart.CFrame = TargetPlayer.Character.HumanoidRootPart.CFrame - TargetPlayer.Character.HumanoidRootPart.CFrame.LookVector * 4
                end
            end
